...
if Meteor.settings.GTM #if there is a Google Tag Manager key in the settings, inject it just after the <body>. Remember to declare globally dataLayer = [] in your code.
    ...
    googleTagManagerScript = '<noscript><iframe src="//www.googletagmanager.com/ns.html?id=' + Meteor.settings.GTM + '" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>' + "<script>window.dataLayer = [];(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
